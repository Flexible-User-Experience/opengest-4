        ...
        foreach ($operatorsFromWorkRegisterHeaders as $operatorId => $workRegisterHeaders) {
            ...
            foreach ($workRegisterHeaders as $workRegisterHeader) {
                ...
                $activeSheet
                    ...
                    ->setCellValue('I'.$i, $detailedHours['holidayHours'])
                    ->setCellValue('J'.$i, $detailedHours['lunch'] + $detailedHours['dinner'])
                    ->setCellValue('K'.$i, $detailedHours['diet'])
                    ->setCellValue('L'.$i, $detailedHours['lunchInt'] + $detailedHours['dinnerInt'])
                    ->setCellValue('M'.$i, $detailedHours['dietInt'])
                    ->setCellValue('N'.$i, $detailedHours['normalHours'])
                    ->setCellValue('O'.$i, $detailedHours['negativeHours'])
                    ->setCellValue('P'.$i, $detailedHours['normalHours'] + $detailedHours['negativeHours'])
                    ->setCellValue('Q'.$i, $detailedHours['extraHours'])
                    ->setCellValue('R'.$i, $detailedHours['holidayHours']);
            ...
            $activeSheet
                ...
                ->setCellValue('Q'.$i, '=SUM(Q6:Q33)')
                ->setCellValue('R'.$i, '=SUM(R6:R33)');
            $i = $workingDays + 6 + 1;
            ...
            $activeSheet
                ...
                ->setCellValue('I'.$i, $prices['holidayHourPrice'])
                ->setCellValue('J'.$i, $prices['lunchPrice'])
                ->setCellValue('K'.$i, $prices['dietPrice'])
                ->setCellValue('L'.$i, $prices['lunchIntPrice'])
                ->setCellValue('M'.$i, $prices['dietIntPrice'])
                ->setCellValue('N'.$i, $prices['normalHourPrice'])
                ->setCellValue('O'.$i, $prices['negativeHourPrice'])
                ->setCellValue('P'.$i, $prices['normalHourPrice'])
                ->setCellValue('Q'.$i, $prices['extraHourPrice'])
                ->setCellValue('R'.$i, $prices['holidayHourPrice']);
            ...
            $activeSheet
                ...
                ->setCellValue('O'.$i, '=O34*O35')
                ->setCellValue('P'.$i, '=P34*P35')
                ->setCellValue('Q'.$i, '=Q34*Q35')
                ->setCellValue('R'.$i, '=R34*R35');
            $i = $workingDays + 6 + 4;
            $activeSheet
            ...
            ++$i;
            $activeSheet
                ->setCellValue('A'.$i, 'FESTIVA')
                ->setCellValue('B'.$i, '=I36');
