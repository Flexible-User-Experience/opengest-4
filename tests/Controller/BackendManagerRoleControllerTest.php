...
/**
 * Class BackendManagerRoleControllerTest.
 *
 * @category Test
 */
class BackendManagerRoleControllerTest extends AbstractBaseTest
{
    /**
     * Test HTTP request is successful for ROLE_MANAGER user.
     *
     * @dataProvider provideSuccessfulUrls
     *
     * @param string $url
     */
    public function testManagerRolePagesAreSuccessful($url)
    {
        $client = $this->getManagerUserClient();
    ...
    public function provideSuccessfulUrls(): array
    {
        return [
            ...
            ['/admin/operarios/revision/list'],
            ['/admin/operarios/revision/create'],
            ['/admin/operarios/revision/1/edit'],
            ['/admin/operarios/revision/1/delete'],
...
//            ['/admin/vendes/albara/1/delete'],
    ...
    /**
     * Test HTTP request is forbidden for ROLE_MANAGER user (ROLE_ADMIN or ROLE_SUPER_ADMIN only).
     *
     * @dataProvider provideForbiddenUrls
     *
     * @param string $url
     */
    public function testManagerRolePagesAreForbidden($url)
    {
        $client = $this->getManagerUserClient();
        $client->request('GET', $url);
    ...
    /**
     * Forbidden Urls provider (ROLE_ADMIN or ROLE_SUPER_ADMIN exclusive).
     *
     * @return array
     */
    public function provideForbiddenUrls(): array
    {
        return [
            ...
            // EnterpriseTransferAccount (ROLE_SONATA_MANAGER_ADMIN)
            ...
            // CollectionDocumentType (ROLE_SONATA_MANAGER_ADMIN)
            ...
            // TimeRange (ROLE_SONATA_MANAGER_ADMIN / ROLE_SUPER_ADMIN)
            ['/admin/configuracion/franjas_horarias/list'],
            ['/admin/configuracion/franjas_horarias/create'],
            ['/admin/configuracion/franjas_horarias/1/edit'],
            ['/admin/configuracion/franjas_horarias/1/delete'],
            // PayslipLineConcept (ROLE_SONATA_MANAGER_ADMIN)
            ...
            // SaleInvoiceDueDate (ROLE_SONATA_MANAGER_ADMIN)
            ...
            // CostAnalysis (ROLE_SONATA_MANAGER_ADMIN)
    ...
    /**
     * Test HTTP request is not found for ROLE_MANAGER user.
     *
     * @dataProvider provideNotFoundUrls
     *
     * @param string $url
     */
    public function testManagerRolePagesAreNotFound($url)
    {
        $client = $this->getManagerUserClient();
        $client->request('GET', $url);
...
//            ['/admin/operarios/revision/1/delete'],
            ['/admin/operarios/revision/1/show'],
            ['/admin/operarios/revision/batch'],
