...
/**
 * Class BackendAdminRoleControllerTest.
 *
 * @category Test
 */
class BackendAdminRoleControllerTest extends AbstractBaseTest
{
    /**
     * Test HTTP request is successful for ROLE_ADMIN user.
     *
     * @dataProvider provideSuccessfulUrls
     *
     * @param string $url
     */
    public function testAdminRolePagesAreSuccessful($url)
    {
...
//            ['/admin/vendes/albara/1/delete'],
    ...
    /**
     * Test HTTP request is forbidden for ROLE_ADMIN user (ROLE_SUPER_ADMIN only).
     *
     * @dataProvider provideForbiddenUrls
     *
     * @param string $url
     */
    public function testAdminRolePagesAreForbidden($url)
    {
        $client = $this->getAdminUserClient();
        $client->request('GET', $url);
    ...
    /**
     * Forbidden Urls provider (ROLE_SUPER_ADMIN exclusive).
     *
     * @return array
     */
    ...
    {
        return [
            // TimeRange (ROLE_SUPER_ADMIN exclusive)
    ...
    /**
     * Test HTTP request is not found for ROLE_ADMIN user.
     *
     * @dataProvider provideNotFoundUrls
     *
     * @param string $url
     */
    public function testAdminRolePagesAreNotFound($url)
    {
        $client = $this->getAdminUserClient();
        $client->request('GET', $url);
